                    ...
                    <div class="window-tabs tabs-box">
                        ...
                        <div class="btns-outer text-center">
                            <ul class="tab-btns tab-buttons clearfix">
                                <li data-tab="#window-styles" class="tab-btn active-btn"><span
                                        class="icon flaticon-window"></span> Window Styles</li>
                                <li data-tab="#door-styles" class="tab-btn"><span
                                        class="icon flaticon-doorway"></span> Door Styles</li>
                            </ul>
                        </div>
                                ...
                                <div class="content">
                                    <div class="row clearfix">
                                        ...
                                        <div class="left-column col-lg-3 col-md-6 col-sm-12">
                                            <div class="inner-column">
                                                ...
                                                <div class="featured-block">
                                                    <div class="inner-box">
                                                        <h3><a href="window-services.html">Casement</a></h3>
                                                        <div class="text">Idea of denouncing pleasure praising born &
                                                            will give completed ...</div>
                                                        <div class="icon-box">
                                                ...
                                                <div class="featured-block">
                                                    <div class="inner-box">
                                                        <h3><a href="window-services.html">Tilt & Turn</a></h3>
                                                        <div class="text">Consequences that are extremely nor</div>
                                                        <div class="icon-box">
                                        ...
                                        <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                            <div class="inner-column">
                                                <div class="image">
                                                    <img src="{{ asset('assets/frontend/images/resource/window-1.png') }}" alt="" />
                                                    ...
                                                    <div class="plus-box frame-one">
                                                        ...
                                                        <div class="tooltip-data">
                                                            <h4>Air Tightness</h4>
                                                            <div class="tooltip-text">Know 8 grade to pursue pleasure
                                                                rationally encounters that are extremely.</div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="right-column col-lg-3 col-md-6 col-sm-12">
                                            <div class="inner-column">
                                                ...
                                                <div class="featured-block">
                                                    <div class="inner-box">
                                                        <h3><a href="window-services.html">Top Rounded</a></h3>
                                                        <div class="text">Know how to pursue pleasure
                                                            encoun-consequences extremely ...</div>
                                                        <div class="icon-box">
                                                ...
                                                <div class="featured-block">
                                                    <div class="inner-box">
                                                        <h3><a href="window-services.html">Bay & Bow</a></h3>
                                                        <div class="text">Know how to pursue pleasure
                                                            encoun-consequences extremely ...</div>
                                                        <div class="icon-box">
