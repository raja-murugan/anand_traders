                        ...
                        <div class="tm_invoice_info_right">
                            ...
                            <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_accent_bg">
                                <div>
                                    ...
                                    <b class="tm_f16 tm_white_color">₹ 1000</b>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <b class="tm_f16 tm_white_color">#1</b>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr class="tm_gray_bg">
                                            ...
                                            <td class="tm_width_1">1</td>
                                            <td class="tm_width_1">8</td>
                                            <td class="tm_width_1">680</td>
                                            <td class="tm_width_1 tm_text_right">5440</td>
                                        </tr>
                                        <tr class="tm_gray_bg">
                                            <td class="tm_width_1">1</td>
                                            <td class="tm_width_5">
                                        ...
                                        <tr class="tm_gray_bg">
                                            ...
                                            <td class="tm_width_1">122.5</td>
                                            <td class="tm_width_1"></td>
                                            <td class="tm_width_1 tm_text_right"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
