                                ...
                                <table>
                                    ...
                                    @foreach ($productsdata as $index => $productsdata_arr)
                                        <tr class="tm_gray_bg">
                                            ...
                                            <td class="tm_width_1">{{$productsdata_arr['bill_width']}}</td>
                                            <td class="tm_width_1">{{$productsdata_arr['bill_height']}}</td>
                                            <td class="tm_width_1">{{$productsdata_arr['bill_qty']}}</td>
                                            <td class="tm_width_1">{{$productsdata_arr['bill_areapersqft']}}</td>
                                            <td class="tm_width_1">{{$productsdata_arr['bill_rate']}}</td>
                                            <td class="tm_width_2 tm_text_right">₹ {{$productsdata_arr['bill_product_total']}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
